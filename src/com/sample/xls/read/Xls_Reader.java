...
//import com.sample.test.FileOutputStream;
//import com.sample.test.XSSFWorkbook;
...
public class Xls_Reader {
	...
	public String getCellData(String sheetName,String colName,int rowNum){
		...
		for(int i=0;i<row.getLastCellNum();i++){
			...
			//if(row.getCell(i).getStringCellValue().trim().equals(colName.trim())) //By timir
		...
		if(cell.getCellType()==Cell.CELL_TYPE_STRING)
		  ...
		  return cellText;
			  ...
			  System.out.println(iCellValue);
			  String cellText = String.valueOf(iCellValue);*/
			  String cellText = "";
	...
	public boolean setCellData(String sheetName,String colName,int rowNum, String data,String url){
		...
		if(colNum==-1)
			return false;
		sheet.autoSizeColumn(colNum); //Timir
		row = sheet.getRow(rowNum-1);
		if (row == null)
			row = sheet.createRow(rowNum-1);
